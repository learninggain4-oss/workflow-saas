        ...
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-3">
            <div className={`rounded-2xl border p-5 shadow-sm ${bgCard}`}>
              ...
              <p className="mt-3 text-2xl font-extrabold capitalize">{currentTier}</p>
            ...
            <div className={`rounded-2xl border p-5 shadow-sm ${bgCard}`}>
              ...
              <p className="mt-3 text-2xl font-extrabold">{usageValue}%</p>
          ...
          <div className={`rounded-3xl border p-5 shadow-sm ${bgCard}`}>
            <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <h3 className="mt-1 text-2xl font-bold">Choose a plan</h3>
              </div>
              ...
              <div className="inline-flex rounded-xl border border-gray-200 bg-gray-100 p-1 dark:border-gray-700 dark:bg-gray-800">
                {['monthly', 'yearly'].map((option) => (
                  <button
                    ...
                    className={`rounded-lg px-3 py-1.5 text-xs font-semibold capitalize transition-colors ${billingCycle === option ? 'bg-white text-indigo-700 shadow-sm dark:bg-gray-900 dark:text-indigo-300' : 'text-gray-500 dark:text-gray-300'}`}
                  >
                    {option}
                  </button>
                ))}
                ...
                <div
                  ...
                  className={`relative rounded-3xl border p-5 transition-all ${
                    plan.active
                      ...
                      : plan.recommended
                        ? 'border-indigo-200 bg-gradient-to-b from-indigo-50 to-white shadow-md dark:border-indigo-800/80 dark:from-indigo-950/30 dark:to-[#111827]'
                        : 'border-gray-200 bg-white dark:border-gray-800 dark:bg-[#111827]'
                  }`}
                >
                  ...
                  <div className="mb-4 flex items-end gap-1">
                    ...
                    <span className="pb-1 text-sm text-gray-500">{plan.suffix}</span>
                  </div>

                  <p className="mb-5 text-sm text-gray-600 dark:text-gray-300">{plan.description}</p>
