...
import { apiBaseUrl, apiSource } from '../../services/api';
...
const classifyError = (err) => {
  ...
  if (err?.request) {
    // Name the host. A crashed or misrouted service often replies without CORS
    // headers, the browser blocks that reply, and axios reports a bare network
