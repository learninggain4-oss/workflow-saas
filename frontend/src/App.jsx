...
function App(){
  ...
  const openEditModal = (t) => { setEditing(t); fetchComments(t.id); }
    ...
    <div className="min-h-screen bg-[#f8fafc] flex">
      <div className="w- min-w- bg-white border-r p-5 flex flex-col h-screen sticky top-0">
        ...
        <div className="mt-auto border-t pt-5">
          ...
          <p className="text- text-gray-500 mb-2">Board: <b className="text-black">{currentBoardName}</b></p>
          ...
          <p className="text- text-gray-400 mt-2">User must register first.</p>
        </div>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-6 w- max-w-full max-h- overflow-y-auto">
            ...
            <div className="mt-6 border-t pt-4">
              ...
              <div className="max-h-40 overflow-y-auto mb-3 space-y-2 border rounded p-2 bg-gray-50">
