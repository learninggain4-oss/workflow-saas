...
# requirements.txt is now pinned to 2.0.54, and the driver is pinned here, so
# the two are independent: a future SQLAlchemy bump cannot silently change it.
